package com.skylight.swipeos.control.prefs;
...
import com.skylight.swipeos.control.R;
import com.skylight.swipeos.control.utils.AppInfo;
import com.skylight.swipeos.control.utils.AppListTask;
import com.skylight.swipeos.control.utils.Utils;
...
public class IntentDialogPreference extends DialogPreference implements AdapterView.OnItemClickListener, AppListTask.OnListCreatedListener {
    ...
    @Override
    public void onListCreated(List<com.skylight.swipeos.control.utils.AppInfo> appInfoList) {
